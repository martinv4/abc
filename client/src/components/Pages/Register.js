        ...
        <div className="container">
            <div className="row">
                <div className="side-col padding-32 white-bg mobile-full-height">
                    <h1 className="margin-s text-center textWhite">Create your account</h1>
                    ...
                    <p className="margin-s link-text textWhite">Already have an account? Login <Link to="/login">here!</Link></p>
                </div>
